...
const Blog1 = () => {
    let blogID = "633146a5096fa004c8e20bb4";
    const [content, setContent] = useState(null)

    useEffect(() => {
        !content &&
        dataAPI.getSingleArticle(blogID).then(data => {
            if (data.success) {
                ...
                <div className="blog-page-content">
                    ...
                    <div className="blog-content-wrapper">
                        <div className="box box-p">
                            ...
                            {content &&
                                <div className="blog-img-para">
                                    <div className="bipara-left">
                                        <img
                                            src={content.author.image === "none" ? Person : hostname + "uploads/user_images/" + content.author.image}
                                            alt=""/>
                                        <div className="bi-text">
                                            <h5>{content.author.firstname + " " + content.author.surname}</h5>
                                            <p>{new Date(content.createdAt).toLocaleDateString().replaceAll("/", ".")}</p>
                                        </div>
                                    </div>
                            ...
                            {/*{content &&*/}
                            {/*    <div className="blog-html-dynamic" data-source="api"*/}
                            {/*         dangerouslySetInnerHTML={{__html: content.html}}/>}*/}

                            <div className={"blog-html-dynamic"}>
